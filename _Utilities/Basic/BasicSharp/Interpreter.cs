...
namespace BasicSharp
{
    public class Interpreter
    {
        ...
        public Interpreter(string input, string p1, string p2, string p3)
        {
            this.lex = new Lexer(input, p1, p2, p3);
            this.vars = new Dictionary<string, Value>();
            this.labels = new Dictionary<string, Marker>();
            this.loops = new Dictionary<string, Marker>();
            this.funcs = new Dictionary<string, BasicFunction>();
        ...
        public Interpreter(string input, List<string> p)
        {
            this.lex = new Lexer(input, p);
            this.vars = new Dictionary<string, Value>();
            this.labels = new Dictionary<string, Marker>();
            this.loops = new Dictionary<string, Marker>();
            this.funcs = new Dictionary<string, BasicFunction>();
        ...
        public Interpreter(string input, List<ParameterModel> p)
        {
            this.lex = new Lexer(input, p);
            this.vars = new Dictionary<string, Value>();
            this.labels = new Dictionary<string, Marker>();
        ...
        void Func()
        {
            printHandler?.Invoke(Expr().ToString() + "xxxxxxxxxxxxxx");
        }
        void Input()
        {
            while (true)
